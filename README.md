...
- <ins>**Athena Queries Python Wrapper**</ins> (https://github.com/FilipeGood/Athena-Queries-Python-Wrapper) - Very simple python script that let's you run athena sql queries from python
